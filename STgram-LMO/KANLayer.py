...
import numpy as np
from spline import *
from utils2 import sparse_mask
...
class KANLayer(nn.Module):
    ...
    -----------
        ...
        device: str
            device
    """
    #def __init__(self, in_dim=3, out_dim=2, num=5, k=3, noise_scale=0.1, scale_base_mu=0.0, scale_base_sigma=1.0, scale_sp=1.0, base_fun=torch.nn.SiLU(), grid_eps=0.02, grid_range=[-1, 1], sp_trainable=True, sb_trainable=True, save_plot_data = True, device='cpu', sparse_init=False):
    def __init__(self, in_dim=3, out_dim=2, num=5, k=3, noise_scale=0.001, scale_base_mu=0.0, scale_base_sigma=1.0, scale_sp=2.0, base_fun=torch.nn.SiLU(), grid_eps=0.01, grid_range=[-1, 1], sp_trainable=True, sb_trainable=True, save_plot_data = True, device='cpu', sparse_init=False):
        ''''
